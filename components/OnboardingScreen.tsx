...
const onboardingData: OnboardingSlide[] = [
  {
    id: "1",
    title: "Selamat Datang di SAPA UMKM",
    subtitle: "Solusi Digital untuk UMKM Indonesia",
    description:
      "Platform terpercaya yang membantu usaha mikro, kecil, dan menengah untuk berkembang dengan teknologi digital yang mudah digunakan.",
  ...
  {
    id: "2",
    title: "Kelola Profil UMKM",
    subtitle: "Data Usaha Terorganisir",
    description:
      "Simpan dan kelola informasi lengkap usaha Anda termasuk NIB, kontak, alamat, dan status usaha dalam satu tempat yang aman.",
  ...
  },
  {
    ...
    subtitle: "Dukungan Profesional",
    description:
      "Akses program bantuan pemerintah, konsultasi bisnis, dan pendampingan dari ahli untuk mengembangkan usaha Anda.",
    icon: "people-outline",
  ...
  },
  {
    ...
    subtitle: "Jangkauan Pasar Lebih Luas",
    description:
      "Jual produk secara online, kelola inventori, dan jangkau pelanggan di seluruh Indonesia dengan platform marketplace terintegrasi.",
