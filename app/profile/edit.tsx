...
function EditProfileScreen() {
  ...
  const loadProfile = useCallback(async () => {
    ...
    try {
      ...
      console.log("Edit - Loading profile with ID:", id);
      const profile = await ProfileStorageService.getProfileById(id);
      console.log("Edit - Profile loaded:", profile);

      if (!profile) {
        console.log("Edit - Profile not found");
      ...
      console.log("Edit - Initial data set");
    } catch (error) {
