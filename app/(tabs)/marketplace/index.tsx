...
function TabMarketplaceScreen() {
  ...
  const handleDeleteProduct = async (product: Product) => {
    console.log(
      "Tab Marketplace - Delete requested for product:",
      product.id,
      product.nama
    );
    Alert.alert(
      ...
      [
        { text: "Batal", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              console.log("Tab Marketplace - Deleting product:", product.id);
              await ProductStorageService.deleteProduct(product.id);
              console.log("Tab Marketplace - Product deleted successfully");
              await loadData();
  ...
  const renderProduct = ({ item }: { item: Product }) => (
    <ProductCard
      ...
      onPress={() => {
        console.log(
          "Tab Marketplace - Navigating to product detail with ID:",
          item.id
        );
        try {
          ...
          console.error(
            "Tab Marketplace - Navigation error for detail:",
            error
          );
        }
      }}
...
export default function ProtectedTabMarketplaceScreen() {
  return (
    <ProtectedRoute>
      <TabMarketplaceScreen />
    </ProtectedRoute>
  );
}
